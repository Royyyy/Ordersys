<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"E:\wamp64\www\Ordersys\public/../application/index\view\user\userDetail.html";i:1517840137;}*/ ?>
<div class="content">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header" data-background-color="purple">
                        ...
                        <p class="category">欢迎来到<?php echo $data['userAccount']; ?>的个人信息管理中心</p>
                    </div>

                    <div class="card-content">
                        <form action="<?php echo url('user/updateUserInfo'); ?>" method="post" enctype="multipart/form-data" >
                            <div class="row">
                                <div class="col-md-5">
                            ...
                            <input type="text" value="<?php echo \think\Session::get('userId'); ?>" name="userId" hidden>
